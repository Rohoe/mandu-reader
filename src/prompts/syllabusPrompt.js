export function buildSyllabusPrompt(langConfig, topic, level, lessonCount, nativeLangName = 'English', { learnerProfile, recentTopics } = {}) {
...
- "suggested_topics": 2-3 follow-up topic ideas (short phrases in ${nativeLangName}) that build on or complement this syllabus
